...
function makeInviteButton(socket_id) {
     ...
     newNode.click( () => {
        ...
        console.log('**** Client log message, sending \'invite\' coomand: '+JSON.stringify(payload));
...
function makeInvitedButton(socket_id) {
     ...
     newNode.click( () => {
        ...
        console.log('**** Client log message, sending \'uninvite\' coomand: '+JSON.stringify(payload));
...
function makePlayButton(socket_id) {
     ...
     let newNode = $(newHTML);
      newNode.click( () => {
        ...
        console.log('**** Client log message, sending \'game_start\' coomand: '+JSON.stringify(payload));
...
socket.on('invite_response', (payload) =>{
  ...
  if((typeof payload == 'underfined') || (payload === null)){
...
function sendChatMessage(){
	...
	console.log('**** Client log message, sending \'send_chat_message\' coomand: '+JSON.stringify(request));
...
socket.on('game_update', (payload) =>{
  ...
  if((typeof board == 'underfined') || (board === null)){
   ...
   if( payload.game.whose_turn === 'white'){
       ...
       $("#my_color").append('<h4>Error: Don\'t know whose turn is</h4>');
            ...
            if(payload.game.whose_turn === my_color){
              ...
              $('#' + row + '_' + column). click(((r, c) => {
                  return (() => {
                     ...
                     console.log('**** Client log message, sending \'play_token\' coomand: '+JSON.stringify(payload));
...
$( () => {
   ...
   request.room = chatRoom;
   request.username = username;
   console.log('**** Client log message, sending \'join_room\' coomand: '+JSON.stringify(request));
